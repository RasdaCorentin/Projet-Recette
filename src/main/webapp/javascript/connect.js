...
//. --------------------Le formulaire.--------------------
var formConnectUtilisateur = document.getElementById("formConnectUtilisateur");
...
var urlConnectUtilisateur = 'http://localhost:8080/Projet-Recette/api/utilisateur/enregistrez/connect';
...
formConnectUtilisateur.addEventListener("submit", function (event) {
    ...
    //= Je change dataConnectUtilisateur en JSON & lance fonction requestTestConnectUtilisateur.
    //= (je passe le mot de passe ici car j'en ai besoin pour construire le cookie)
    dataConnectUtilisateur = JSON.stringify(dataConnectUtilisateur);
    requestTestConnectUtilisateur(dataConnectUtilisateur, password);
});
...
function requestTestConnectUtilisateur(dataConnectUtilisateur, password) {

    //$ --------------------Création du headers.--------------------

    http.open(method, urlConnectUtilisateur);
    ...
    //$ --------------------Envoie des données.--------------------
    http.send(dataConnectUtilisateur);
};